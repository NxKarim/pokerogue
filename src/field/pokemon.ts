  ...
  apply(source: Pokemon, move: Move): HitResult {
    ...
    case MoveCategory.SPECIAL:
      ...
      if (cancelled.value) {
        ...
        applyPreDefendAbAttrs(PreDefendDisguiseDamageAbAttr, this, source, move, cancelled, damage);
